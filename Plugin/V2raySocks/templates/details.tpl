                        ...
                        <table class="table general-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Clash</td>
                                    <td>
                                        <button name="url" class="btn btn-primary btn-xs btyurlothers" data-unit=".btyurlothers" data-params="https://{$HTTP_HOST}/modules/servers/V2raySocks/clash.php?sid={$serviceid}&token={$subscribe_token}" data-done="{V2raySocks_get_lang('copy_success')}">
                                                <i class="fa fa-code"></i>
                                                {V2raySocks_get_lang('copy')}
                                            </button>
                                    </td>
